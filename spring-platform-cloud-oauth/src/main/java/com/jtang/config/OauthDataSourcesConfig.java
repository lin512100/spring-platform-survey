 ...
 */
@Configuration
@MapperScan(basePackages = "com.jtang.oauth.mapper",
        sqlSessionFactoryRef = "oauthSqlSessionFactory")
public class OauthDataSourcesConfig {

    public static final String DATABASE_PREFIX = "spring.datasource.oauth.";

    public static final String DATA_SOURCE_NAME = "oauthDataSource";
    public static final String SQL_SESSION_FACTORY = "oauthSqlSessionFactory";
