...
//        dsc.setUrl("jdbc:mysql://129.204.1.173:3306/platform-zuul?useUnicode=true&serverTimezone=UTC&useSSL=false");
...
//        generatorParamDTO.setModuleName("zuul");
//        String[] includeTable = new String[]{"platform_roster"};
